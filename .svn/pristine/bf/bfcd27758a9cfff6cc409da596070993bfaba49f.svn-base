	...
	<div class="accordion" id="menu-c082a1303cf14573916c963071bdddc4" style="display: none;">
		...
		<div class="accordion-group">
		    ...
		    <div id="collapse-bc4518efa5d043958b69590f6cca5ec1" class="accordion-body collapse ">
				<div class="accordion-inner">
					<ul class="nav nav-list">
						<li><a data-href=".menu3-be189f93d8fe4f77a6fde050f3ddc7b7" href="gongSiList" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;公司客户</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
		...
		<div class="accordion-group">
		    ...
		    <div id="collapse-d44fe7ff911341d5bb7e5c501f1d6d27" class="accordion-body collapse ">
				<div class="accordion-inner">
					<ul class="nav nav-list">
						<li><a data-href=".menu3-d01bab3ae2854fcf81b9c5f063f9056d" href="sheBaoList" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;社保信息</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
							
							</ul></li>
						<li><a data-href=".menu3-786133f2fdf547be8bd8c4e213c20ff3" href="sheBaoJiLu" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;社保记录</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
							</ul></li>
						<li><a data-href=".menu3-8d338395c6d2477ab1028e9789dd3dab" href="sheBaoRecord" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;社保缴费</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
							
							</ul></li>
						<li><a data-href=".menu3-60702152789349b895607523f623d46b" href="cuiJiaoSheBao" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;社保催交</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
		...
		<div class="accordion-group">
		    ...
		    <div id="collapse-4e35e5ef243f48b5a4d81cb2920214a6" class="accordion-body collapse ">
				<div class="accordion-inner">
					<ul class="nav nav-list">
						<li><a data-href=".menu3-059199c2d9804ef8883822dd1adb7935" href="selectAll" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;公积金查询</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
							
							</ul></li>
						<li><a data-href=".menu3-b9fd18369098410aa7ce9f76710df4a9" href="customerList" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;公积金缴费</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
							
							</ul></li>
						<li><a data-href=".menu3-27e37abcf1284c309569eed2c9027a11" href="cuiJiaoSheBao" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;公积金催交</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
		...
		<div class="accordion-group">
		    ...
		    <div id="collapse-2d661bc23f10434ab743ea292c22edcc" class="accordion-body collapse ">
				<div class="accordion-inner">
					<ul class="nav nav-list">
					<!-- data-href=".menu3-92cef87c45734b0592953b544d55818b" -->
						<li><a data-href=".menu3-92cef87c45734b0592953b544d55818b" href="zhaopinList" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;招聘信息</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
							
							</ul></li>
						<li><a data-href=".menu3-3556301c31ac4747965b53ca3c940191" href="personList" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;人才信息</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
							
							</ul></li>
						<li><a data-href=".menu3-5cbbb1056ebf471b8922e69f157455c5" href="laowuList" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;劳务派遣</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
		...
		<div class="accordion-group">
		    ...
		    <div id="collapse-822de1f5c7594e7f9586b0685c028541" class="accordion-body collapse ">
				<div class="accordion-inner">
					<ul class="nav nav-list">
						<li><a data-href=".menu3-9ff71084c3c44748a3a699d05d124ff9" href="emailList" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;营销查询</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
							
							</ul></li>
						<li><a data-href=".menu3-9fd2bbad28414d7b9df3d871cda6543c" href="smsSendsave" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;短信营销</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
							
							</ul></li>
						<li><a data-href=".menu3-23e1d105dd774ba492ea4f1006d3bc73" href="emailSend" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;邮件营销</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
		...
		<div class="accordion-group">
		    ...
		    <div id="collapse-07070e9f5f504140ac5327d9ea387ab1" class="accordion-body collapse ">
				<div class="accordion-inner">
					<ul class="nav nav-list">
						<li><a data-href=".menu3-2a119dc5be3348a4991ebbd565e9d783" href="sheBaoCount" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;社保费用统计</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
							
							</ul></li>
						<li><a data-href=".menu3-2f138487b1ba4ee09f0d67a45ae57c67" href="gongJiJinCount" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;公积金统计</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
							
							</ul></li>
						<li><a data-href=".menu3-bd2d297719a246ce90137b7c9ca6b909" href="gongZiCount" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;工资费用统计</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
							
							</ul></li>
						<li><a data-href=".menu3-d97120cbc31f424dbd12959da541fbda" href="renCaiCount" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;人才外包统计</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
							
							</ul></li>
						<li><a data-href=".menu3-aa3843cca0254bcb807123e8284bb193" href="caiWuCount" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;财务报表统计</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
		...
		<div class="accordion-group">
		    ...
		    <div id="collapse-b82f37a26c1f413588db85b2eaf782e2" class="accordion-body collapse ">
				<div class="accordion-inner">
					<ul class="nav nav-list">
						<li><a data-href=".menu3-c96dfbfd2691492f82c8b7de876f7c92" href="xinwenlist" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;新闻管理</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
	...
	<div class="accordion" id="menu-2">
		<div class="accordion-group">
		    ...
		    <div id="collapse-7c8cd0b6c9e3409aae7e9ad9bd2e74b1" class="accordion-body collapse in">
				<div class="accordion-inner">
					<ul class="nav nav-list">
						<li class="active"><a data-href=".menu3-bfeacdcd326b476181423fe8ec0cb527" href="saved_resource?ur=saved_resource" target="mainFrame"><i class="icon-circle-arrow-right icon-white"></i>&nbsp;用户管理</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
						...
						<li><a data-href=".menu3-c9d372c1a9c84bbe8c46686c41d67cfb" href="duanXinList" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;短信模板</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
							
							</ul></li>
						<li><a data-href=".menu3-aad070d5b282458996dcf847542926b8" href="youJianList" target="mainFrame"><i class="icon-circle-arrow-right"></i>&nbsp;邮件模板</a>
							<ul class="nav nav-list hide" style="margin:0;padding-right:0;">
				...
				<div id="right" style="height: 510px; width: 1185px;">
					<iframe id="mainFrame" name="mainFrame" src="static/index/saved_resource.html" style="overflow: visible; height: 510px;" scrolling="yes" frameborder="no" width="100%" height="650"></iframe>
				</div>
			</div>
