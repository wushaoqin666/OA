...
<body>
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="javaScript:void(0)">公积金修改</a></li>
	</ul>
	<br>
	<form id="inputForm" class="form-horizontal" action="updateGjj"
		method="post" novalidate="novalidate">
		<input id="id" name="tb_accumulation_fund.id" type="hidden" value="${tb_accumulation_fund.id }">
			...
			<div class="controls">
				<select name="tb_accumulation_fund.customer.id"
					...
					<c:forEach items="${cusList }" var="cc">
						<option value="${cc.id }"
							${cc.idCard == tb_accumulation_fund.idCard?"selected":""  }>${cc.name }</option>
					</c:forEach>
				</select>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="idcard" name="tb_accumulation_fund.idCard" class="input-xlarge required"
					type="text" value="${tb_accumulation_fund.idCard }" maxlength="20"> <span
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="accountno" name="tb_accumulation_fund.accountNo" class="input-xlarge required"
					type="text" value="${tb_accumulation_fund.accountNo }" maxlength="20"> <span
					class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input id="paydate" name="tb_accumulation_fund.payDate" class="input-xlarge required"
					type="text" value="${tb_accumulation_fund.payDate }" maxlength="20"> <span
					class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input id="paymoney" name="tb_accumulation_fund.payMoney" class="input-xlarge required"
					type="text" value="${tb_accumulation_fund.payMoney }" onclick="WdatePicker()"> <span class="help-inline"><font
					color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input id="proxyfee" name="tb_accumulation_fund.proxyFee" class="input-xlarge "
					type="text" value="${tb_accumulation_fund.proxyFee }">
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<select name="tb_accumulation_fund.status" class="input-xlarge">
					<option value="0" ${tb_accumulation_fund.status == 0?"selected":"" }>已交</option>
					<option value="1" ${tb_accumulation_fund.status == 1?"selected":"" }>未交</option>
				</select>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input id="remark" name="tb_accumulation_fund.remark" class="input-xlarge " type="text"
					value="${tb_accumulation_fund.remark }" maxlength="256">
			</div>
		</div>
