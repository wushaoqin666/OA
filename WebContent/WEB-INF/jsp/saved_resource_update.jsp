...
<body>
	...
	<form id="inputForm" class="form-horizontal" action="updatenews" method="post" novalidate="novalidate">
...
<script type="text/javascript">top.$.jBox.closeTip();</script>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="newstitle" name="tb_news.newstitle" class="input-xlarge required" type="text" value="${tb_news.newstitle }" maxlength="128">
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea id="content" name="tb_news.content" maxlength="150" class="input-xxlarge" rows="4">&amp;lt;p&amp;gt;
	${tb_news.content }&amp;lt;/p&amp;gt;</textarea>
...
<script type="text/javascript">
	...
	contentCkeditor.config.ckfinderUploadPath="/hrpms/news/"+year+"/"+month+"/";//
		...
		<div class="control-group">
			...
			<div class="controls">
				<select name="tb_news.status" style="width:280px;" class="select2-offscreen" >
					<option ${tb_news.status ==0?"selected":""} value="0">显示</option>
					<option ${tb_news.status ==1?"selected":""} value="1">隐藏</option>
...
<!-- 		</div> -->
		<div class="control-group">
			...
			<div class="controls">
				<input id="remark" name="tb_news.remark " class="input-xlarge " type="text" value="${tb_news.remark }" maxlength="256">
			</div>
		</div>
