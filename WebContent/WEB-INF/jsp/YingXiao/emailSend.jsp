...
<script type="text/javascript">top.$.jBox.closeTip();</script>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="subject" name="subject" class="input-xlarge required" type="text" value="${youjian.subject }" maxlength="128">
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<textarea id="content" name="content" maxlength="256" class="input-xxlarge required" rows="4">${youjian.content }</textarea>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
