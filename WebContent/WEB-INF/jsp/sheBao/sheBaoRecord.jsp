...
<body>
	...
	<ul class="nav nav-tabs">
		<li><a href="sheBaoJiLu">社保缴费列表</a></li>
		<li class="active"><a href="sheBaoRecord">社保缴费添加</a></li>
	</ul><br>
...
<script type="text/javascript">top.$.jBox.closeTip();</script>
		...
		<table class="table table-bordered table-condensed">
			<tbody><tr>
				...
				<td>
					<input type="text" id="customer_name" name="name"  onblur="getCustomerByName();" style="width:270px;">
				</td>
