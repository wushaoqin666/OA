...
<body>
	...
	<form id="inputForm" class="form-horizontal" action="addSms_record" method="post" novalidate="novalidate">
...
<script type="text/javascript">top.$.jBox.closeTip();</script>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="userId" name="userId" class="input-xlarge required" type="text" maxlength="512">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">接收人电话：</label>
			<div class="controls">
				<input id="telephone" name="tb_sms_record.telephone" class="input-xlarge required" type="text" maxlength="512">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="templateId" value="${duanXin.subject }" htmlescape="false" maxlength="512" class="input-xlarge required">
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea id="content" name="tb_sms_record.content" class="input-xxlarge required" rows="4">${duanXin.content }</textarea>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
<!-- 		<div class="control-group"> -->
